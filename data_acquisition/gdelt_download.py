...
Original Author: Bruno Conte | bruno.conte@barcelonagse.eu

Modifications and Additional Contributions by: Luis Quiñones, Margherita Phillip and Giovanna Chaves

In this current version, we have made various modifications to the original script. W
e skip the gdelt package and directly download the GDELT
